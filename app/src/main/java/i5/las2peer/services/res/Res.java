...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "224", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-224/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @Consumes(MediaType.TEXT_PLAIN)
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_NOT_FOUND, message = "resnotfound")
  })
  @ApiOperation(value = "testtest", notes = " ")
  public Response testtest(@PathParam("id") String id) {
    ...
    // resnotfound
    boolean resnotfound_condition = true;
    if(resnotfound_condition) {
      JSONObject res = new JSONObject();
